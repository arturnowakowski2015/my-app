  ...
  furl(i, id, title) {    
    ...
    fetch(this.state.urls[ i])
        ...
        .then((response) => {
            ...
            this.setState({ data: response.map((t) => {
...
m(e){ 
  this.setState({data: this.props.data.map((t, i) => {  
...
setRec(){ 
  ...
  let t = v.map((t, i) => { console.log(this.props.params.id+" post   " +i);
...
{  
  ...
  render(){      console.log("ffffffffff111111111111111111111111111111ffffffffffffff   "+JSON.stringify( this.props.params))
    return ( 
                          ...
                          <Link class="a2" to="/a/pagination/settings" onClick={() => this.setState({settings:1})}>settings</Link>    
                           ...
                           {this.state.change && 
                            ...
                            columns={this.state.columns.map((t, i) => { 
                              ...
                              console.log("b1b   "+JSON.stringify(this.state.columns));
                                            return   t  ;
                                        })}
